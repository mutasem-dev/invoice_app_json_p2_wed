...
import 'package:invoice_app_json/details_page.dart';
...
class _InvoiceAppState extends State<InvoiceApp> {
  ...
  void initState() {
    ...
    super.initState();
    if (InvoiceApp.invoices.isNotEmpty)
      InvoiceApp.invoiceNo = InvoiceApp.invoices.last.id + 1;
  }
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              ElevatedButton(
                  onPressed: () {
                    Navigator.pushNamed(context, '/invoices_list');
                  },
